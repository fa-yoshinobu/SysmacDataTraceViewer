...
- `Release Single EXE`: push a tag like `v1.0.4` or `Ver.1.0.4` that matches the project `<Version>` to build the `win-x64` self-contained Single EXE and create a GitHub Release automatically.
